...
final class Camera3DSurfaceView extends GLSurfaceView implements IVideo3DSurfaceView {
    ...
    protected Camera3DSurfaceView(Context context) {
        super(context);
        mContext=context;
...
*/
                ...
                String mFragmentShader1 =
                    ...
                    "lowp vec4 interleave1(highp vec4 p, vec4 left, vec4 right, float subpos, vec2 texCoord) {\n"+
...
*/
                    ...
                    " vec2 t = texCoord.xy; t.x=t.x/2.0; \n" +
...
*/            		"  if (bars>4.5) { \n" +
      ...
      String mFragmentShader2 =
        		    ...
        		    "   right=tmp; \n" +
        		    "  } \n" +
                    "  gl_FragColor.r=interleave1(gl_FragCoord, left,right,2.0, tc).r;\n" +
                    "  gl_FragColor.g=interleave1(gl_FragCoord, left,right,1.0, tc).g;\n"+
                    //"  gl_FragColor.g=1.0;\n" +
                    "  gl_FragColor.b=interleave1(gl_FragCoord, left,right,0.0, tc).b;\n"+
                    "}\n";        
        ...
        public void onDrawFrame(GL10 glUnused) {
            ...
            GLES20.glUniform1i(muTextureLeftHandle, 1);
            ...
            if (muSTMatrixLeftHandle!=-1) GLES20.glUniformMatrix4fv(muSTMatrixLeftHandle, 1, false, mSTMatrixLeft, 0);
            if (muSTMatrixRightHandle!=-1) GLES20.glUniformMatrix4fv(muSTMatrixRightHandle, 1, false, mSTMatrixRight, 0);
        ...
        public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
            ...
            mSurfaceTextureLeft.setOnFrameAvailableListener(this);

            mSurfaceTextureRight = new SurfaceTexture(mTextureIDRight);
            mSurfaceTextureRight.setOnFrameAvailableListener(this);
    ...
    public SurfaceTexture getSurfaceTextureLeft() {
        return mRenderer.getSurfaceTextureLeft();
    }

    public SurfaceTexture getSurfaceTextureRight() {
        return mRenderer.getSurfaceTextureRight();
    }
