 ...
 *
 */
public class TestTwoSurfaceView extends android.view.SurfaceView implements Runnable, OnFrameAvailableListener, SurfaceHolder.Callback {
    ...
    private TwoTextureManager mTextureManager = null;
    ...
    public TestTwoSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mHandler = new Handler();
        getHolder().addCallback(this);
    }

    private SurfaceReadyListener mReadyListenner;
    public interface SurfaceReadyListener {
        void OnSurfaceReady();
    }

    public void setSurfaceReadyListener(SurfaceReadyListener listener) {
        mReadyListenner = listener;
    }
...
//    }
    ...
    public SurfaceTexture getSurfaceTextureLeft() {
        ...
        return mTextureManager.getSurfaceTextureLeft();
    }
    ...
    public SurfaceTexture getSurfaceTextureRight() {
        ...
        return mTextureManager.getSurfaceTextureRight();
    }
    ...
    public void startGLThread() {
        ...
        if (mTextureManager == null) {
            mTextureManager = new TwoTextureManager();
        }

        if (mTextureManager.getSurfaceTextureLeft() == null) {
            mThread = new Thread(TestTwoSurfaceView.this);
            mRunning = true;
            mThread.start();
    ...
    public void run() {
        ...
        mTextureManager.getSurfaceTextureLeft().setOnFrameAvailableListener(this);
        mTextureManager.getSurfaceTextureRight().setOnFrameAvailableListener(this);
        mReadyListenner.OnSurfaceReady();
                ...
                synchronized (mSyncObject) {
                    ...
                    if (mFrameAvailable) {
                        ...
                        if (mCodecSurfaceManager != null) {
                            ...
                            mTextureManager.drawFrame();
                            oldts = ts;
                            ts = mTextureManager.getSurfaceTextureLeft().getTimestamp();
